...
set NDK_ROOT=C:/Users/LingJianfeng/Desktop/jsb/ndk/android-ndk-r9b
...
python %CXX_GENERATOR_ROOT%/generator.py %CXX_GENERATOR_ROOT%/MyBinding/test.ini -t spidermonkey -s testandroid -o %OUTPUT_DIR%
