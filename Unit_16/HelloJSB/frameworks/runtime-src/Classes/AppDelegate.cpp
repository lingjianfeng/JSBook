...
//
#include "jeff/auto/jsb_jeff_external_auto.hpp" // 引入绑定代码文件
...
bool AppDelegate::applicationDidFinishLaunching()
{
    ...
    if(!glview) {
        ...
        glview = cocos2d::GLViewImpl::create("HelloJSB");
#else
        glview = cocos2d::GLViewImpl::createWithRect("HelloJSB", Rect(0,0,900,640));
#endif
    ...
    sc->addRegisterCallback(register_all_user_external);
