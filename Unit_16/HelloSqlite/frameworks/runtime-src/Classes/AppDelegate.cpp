...
// ... ...
// 引入自动绑定代码文件
#include "sqlite/auto/jsb_sqlite_external_auto.hpp"
...
bool AppDelegate::applicationDidFinishLaunching(){
    ...
    if(!glview) {
        ...
        glview = cocos2d::GLViewImpl::create("HelloSqlite");
#else
        glview = cocos2d::GLViewImpl::createWithRect("HelloSqlite", Rect(0,0,900,640));
#endif
    ...
    // 绑定函数注册
    sc->addRegisterCallback(register_all_sqlite_external);
